...
function AuthModal({ isOpen, onClose }) {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      if (isSignup) {
        const response = await axios.post('https://donjerseyssporthouseserver-71ee.onrender.com/signup', { username, email, password });
        ...
        const response = await axios.post('https://donjerseyssporthouseserver-71ee.onrender.com/login', { identifier, password });
