...
function AuthModal({ isOpen, onClose }) {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      if (isSignup) {
        const response = await axios.post('https://donjerseysporthouseco.co.ke/backend/auth/signup', { username, email, password });
        ...
        const response = await axios.post('https://donjerseysporthouseco.co.ke/backend/auth/login', { identifier, password });
